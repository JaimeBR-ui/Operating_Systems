...
public class SantaScenario {
	...
	public static void main(String args[]) {
		...
		scenario.santasDoor = new HashSet<Integer>();
		scenario.isDecember = false;
		scenario.available = new Semaphore(3, true);
		scenario.atShed = new Semaphore(0, true);
		...
		for(int day = 1; day < 500; day++) {
			...
			// System.out.println(scenario.available.availablePermits());
		}
	}
}
